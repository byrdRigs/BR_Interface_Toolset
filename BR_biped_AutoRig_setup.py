...
def gui():
	...
	pm.text(l="There are some icons that you can move to the place that you want them to be, and the others can't. You can scale all of the icons to better fit your character.", w=win_width, ww=1, bgc=color_3)
...
def biped_locImport(*args):
	...
	lt_index_01_loc = loc_grp[67]
	lt_middle_01_loc = loc_grp[52]
	lt_pinky_01_loc = loc_grp[62]
	lt_ring_01_loc = loc_grp[57]
