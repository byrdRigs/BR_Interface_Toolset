...
def gui():
	...
	pm.text(l="You can scale the icons to better fit your character.", w=win_width, ww=1, bgc=color_3)
	...
	'''
	pm.setParent(manual_sub_layout)
	neck_layout = pm.frameLayout(w=win_width, l='Neck', bgc=color_5, cl=1, cll=1, cc=windowResize)
	pm.columnLayout()
	pm.button('neckSetup_button', l='Neck Setup', w=win_width, bgc=color_6, c=neckSetup)
	pm.separator(w=win_width, bgc=color_7, st='in')
	...
	Back
	'''
	back_layout = pm.frameLayout(w=win_width, l='Back', bgc=color_6, cl=1, cll=1, cc=windowResize)
	pm.columnLayout()
	pm.button('back_button', l='Back Setup', w=win_width, bgc=color_7, c=backSetup)


	pm.setParent(manual_sub_layout)
	pm.separator('backFrame_sep', w=win_width, bgc=color_6, st='in')


	'''
	Hip
	'''
	hip_layout = pm.frameLayout(w=win_width, l='Hip', bgc=color_7, cl=1, cll=1, cc=windowResize)
	pm.columnLayout()
	pm.button('hip_button', l='Hip Setup', w=win_width, bgc=color_8, c=hipSetup)


	pm.setParent(manual_sub_layout)
	pm.separator('hipFrame_sep', w=win_width, bgc=color_7, st='in')
...
def freezeScale(selection):
	selection = pm.ls(sl=1)
	pm.makeIdentity(selection, apply=1, s=1)
	# print 'Scale Transforms Frozen'
...
def biped_locImport(*args):
	...
	global lt_thumb_01_loc, icon, icon_grp, scaledIcons
	...
	jaw_01_loc = loc_grp[36]
	lt_eye_01_loc = loc_grp[38]
	lt_clav_01_loc = loc_grp[40]
	lt_arm_01_loc = loc_grp[42]
	lt_hand_01_loc = loc_grp[45]
	lt_thumb_01_loc = loc_grp[47]
	lt_index_01_loc = loc_grp[52]
	lt_middle_01_loc = loc_grp[57]
	lt_ring_01_loc = loc_grp[62]
	lt_pinky_01_loc = loc_grp[67]
	...
	icon_grp = loc_grp[72]
	lt_leg_01_icon = loc_grp[73]
	lt_leg_02_icon = loc_grp[75]
	lt_leg_03_icon = loc_grp[77]
	lt_leg_04_icon = loc_grp[79]
	ct_eye_icon = loc_grp[81]
	rt_eye_icon = loc_grp[82]
	lt_eye_icon = loc_grp[83]
	ct_jaw_icon = loc_grp[85]
	lt_foot_icon = loc_grp[87]
	ct_hip_icon = loc_grp[89]
	ct_back_icon = loc_grp[91]
	ct_COG_icon = loc_grp[93]
	ct_back_01_icon = loc_grp[95]
	ct_back_02_icon = loc_grp[97]
	lt_shoulder_icon = loc_grp[99]
	ct_chest_icon = loc_grp[101]
	lt_arm_icon = loc_grp[103]
	lt_arm_01_icon = loc_grp[105]
	lt_gimbal_icon = loc_grp[106]
	lt_arm_02_icon = loc_grp[108]
	lt_hand_icon = loc_grp[110]
	lt_thumb_01_pivot_icon = loc_grp[112]
	lt_thumb_02_icon = loc_grp[114]
	lt_thumb_03_icon = loc_grp[116]
	lt_thumb_04_icon = loc_grp[118]
	lt_index_01_icon = loc_grp[120]
	lt_index_02_icon = loc_grp[122]
	lt_index_03_icon = loc_grp[124]
	lt_index_04_icon = loc_grp[126]
	lt_middle_01_icon = loc_grp[128]
	lt_middle_02_icon = loc_grp[130]
	lt_middle_03_icon = loc_grp[132]
	lt_middle_04_icon = loc_grp[134]
	lt_ring_01_icon = loc_grp[136]
	lt_ring_02_icon = loc_grp[138]
	lt_ring_03_icon = loc_grp[140]
	lt_ring_04_icon = loc_grp[142]
	lt_pinky_01_icon = loc_grp[144]
	lt_pinky_02_icon = loc_grp[146]
	lt_pinky_03_icon = loc_grp[148]
	lt_pinky_04_icon = loc_grp[150]
	ct_neck_fk_icon = loc_grp[152]
	ct_neck_icon = loc_grp[154]
	lt_leg_ikfk_switch = loc_grp[156]
	lt_elbow_icon = loc_grp[158]
	lt_arm_hybrid_icon = loc_grp[159]
	lt_knee_icon = loc_grp[162]
	lt_arm_ikfk_switch = loc_grp[164]
	ct_moveAll_icon = loc_grp[166]
	ct_anim_icon = loc_grp[167]
	ct_head_icon = loc_grp[168]
	lt_fingers_icon = loc_grp[170]
	lt_index_icon = loc_grp[171]
	lt_middle_icon = loc_grp[172]
	lt_ring_icon = loc_grp[173]
	lt_pinky_icon = loc_grp[174]
	# print('icon_grp:', icon_grp)
	# print('lt_leg_01_icon:', lt_leg_01_icon)
	# print('lt_leg_02_icon:', lt_leg_02_icon)
	# print('lt_leg_03_icon:', lt_leg_03_icon)
	# print('lt_leg_04_icon:', lt_leg_04_icon)
	# print('ct_eye_icon:', ct_eye_icon)
	# print('lt_eye_icon:', lt_eye_icon)
	# print('rt_eye_icon:', rt_eye_icon)
	# print('ct_jaw_icon:', ct_jaw_icon)
	# print('lt_foot_icon:', lt_foot_icon)
	# print('ct_hip_icon:', ct_hip_icon)
	# print('ct_back_icon:', ct_back_icon)
	# print('ct_COG_icon:', ct_COG_icon)
	# print('ct_back_01_icon:', ct_back_01_icon)
	# print('ct_back_02_icon:', ct_back_02_icon)
	# print('lt_shoulder_icon:', lt_shoulder_icon)
	# print('ct_chest_icon:', ct_chest_icon)
	# print('lt_arm_icon:', lt_arm_icon)
	# print('lt_arm_01_icon:', lt_arm_01_icon)
	# print('lt_gimbal_icon:', lt_gimbal_icon)
	# print('lt_arm_02_icon:', lt_arm_02_icon)
	# print('lt_hand_icon:', lt_hand_icon)
	# print('lt_thumb_01_pivot_icon:', lt_thumb_01_pivot_icon)
	# print('lt_thumb_02_icon:', lt_thumb_02_icon)
	# print('lt_thumb_03_icon:', lt_thumb_03_icon)
	# print('lt_thumb_04_icon:', lt_thumb_04_icon)
	# print('lt_index_01_icon:', lt_index_01_icon)
	# print('lt_index_02_icon:', lt_index_02_icon)
	# print('lt_index_03_icon:', lt_index_03_icon)
	# print('lt_index_04_icon:', lt_index_04_icon)
	# print('lt_middle_01_icon:', lt_middle_01_icon)
	# print('lt_middle_02_icon:', lt_middle_02_icon)
	# print('lt_middle_03_icon:', lt_middle_03_icon)
	# print('lt_middle_04_icon:', lt_middle_04_icon)
	# print('lt_ring_01_icon:', lt_ring_01_icon)
	# print('lt_ring_02_icon:', lt_ring_02_icon)
	# print('lt_ring_03_icon:', lt_ring_03_icon)
	# print('lt_ring_04_icon:', lt_ring_04_icon)
	# print('lt_pinky_01_icon:', lt_pinky_01_icon)
	# print('lt_pinky_02_icon:', lt_pinky_02_icon)
	# print('lt_pinky_03_icon:', lt_pinky_03_icon)
	# print('lt_pinky_04_icon:', lt_pinky_04_icon)
	# print('ct_neck_fk_icon:', ct_neck_fk_icon)
	# print('ct_neck_icon:', ct_neck_icon)
	# print('lt_leg_ikfk_switch:', lt_leg_ikfk_switch)
	# print('lt_elbow_icon:', lt_elbow_icon)
	# print('lt_arm_hybrid_icon:', lt_arm_hybrid_icon)
	# print('lt_knee_icon:', lt_knee_icon)
	# print('lt_arm_ikfk_switch:', lt_arm_ikfk_switch)
	# print('ct_moveAll_icon:', ct_moveAll_icon)
	# print('ct_anim_icon:', ct_anim_icon)
	# print('ct_head_icon:', ct_head_icon)
	# print('lt_fingers_icon:', lt_fingers_icon)
	# print('lt_index_icon:', lt_index_icon)
	# print('lt_middle_icon:', lt_middle_icon)
	# print('lt_ring_icon:', lt_ring_icon)
	# print('lt_pinky_icon:', lt_pinky_icon)

	scaledIcons = [ct_anim_icon, ct_back_01_icon, ct_back_02_icon, ct_back_icon, ct_chest_icon, ct_COG_icon, ct_eye_icon,
				   ct_head_icon, ct_hip_icon, ct_jaw_icon, ct_moveAll_icon, ct_neck_fk_icon, ct_neck_icon, lt_arm_01_icon, 
				   lt_arm_02_icon, lt_arm_hybrid_icon, lt_arm_icon, lt_arm_ikfk_switch, lt_elbow_icon, lt_eye_icon, lt_fingers_icon, 
				   lt_foot_icon, lt_gimbal_icon, lt_hand_icon, lt_index_01_icon, lt_index_02_icon, lt_index_03_icon, lt_index_04_icon, 
				   lt_index_icon, lt_knee_icon, lt_leg_01_icon, lt_leg_02_icon, lt_leg_03_icon, lt_leg_04_icon, lt_leg_ikfk_switch, 
				   lt_middle_01_icon, lt_middle_02_icon, lt_middle_03_icon, lt_middle_04_icon, lt_middle_icon, lt_pinky_01_icon, 
				   lt_pinky_02_icon, lt_pinky_03_icon, lt_pinky_04_icon, lt_pinky_icon, lt_ring_01_icon, lt_ring_02_icon, lt_ring_03_icon, 
				   lt_ring_04_icon, lt_ring_icon, lt_shoulder_icon, lt_thumb_01_pivot_icon, lt_thumb_02_icon, lt_thumb_03_icon, 
				   lt_thumb_04_icon, rt_eye_icon]

def jointConvertRename(ori, system_name):
	global joint_chain
	pm.select('joint1')
	...
	pm.joint(joint_chain, zso=1, ch=1, e=1, oj='xyz', secondaryAxisOrient='ydown')
	pm.setAttr(joint_chain[-1] + '.jointOrientX', 0)
	pm.setAttr(joint_chain[-1] + '.jointOrientY', 0)
	pm.setAttr(joint_chain[-1] + '.jointOrientZ', 0)

ori = ['ct', 'lt', 'rt']
system_name = ['root', 'hip', 'back', 'clav', 'neck', 'head', 'eye', 'jaw', 'arm', 'hand', 'index', 'middle', 'ring',
			   'pinky', 'thumb', 'leg', 'toeA', 'toeB', 'toeC', 'toeD', 'toeE']
...
def jointConvert(*args):
	...
	pm.parent('*_01_*loc', icon)
	
	'''
	Converting the locators and remaning them
	'''

	selection = pm.ls(back_01_loc, sl=1, dag=1, transforms=1)
	selLen = len(selection)
	# print('Selection:', selection)
	# print('Selected Length:', selLen)
	pm.select(cl=1)


	for each in selection:
		loc_pos = pm.xform(each, q=True, ws=True, t=1)
		# print(loc_pos)
		joints = pm.joint(p=loc_pos)

	jointConvertRename(ori[0], system_name[2])
	...
	selection = pm.ls(sl=1, dag=1, transforms=1)
	selLen = len(selection)
	# print('Selection:', selection)
	# print('Selected Length:', selLen)
	pm.select(cl=1)
	...
	jointConvertRename(ori[0], system_name[5])
	...
	pm.select('joint1')
	ct_hip_01_bind = pm.ls(sl=1)[0]

	hip_count = 1
	hip_suffix = 'bind'
	new_name = '{0}_{1}_0{2}_{3}'.format(ori[0], system_name[1], hip_count, hip_suffix)
	ct_hip_01_bind.rename(new_name)
	...
	jointConvertRename(ori[0], system_name[7])
	...
	jointConvertRename(ori[0], system_name[4])
	...
	jointConvertRename(ori[0], system_name[0])
	...
	if pm.objExists(lt_arm_01_loc):
		...
		jointConvertRename(ori[1], system_name[8])
		lt_arm_01_bind = joint_chain[0]
		# print('Arm Bind:', lt_arm_01_bind)
	else:
		pm.error("Arm doesn't exist")
	...
	if pm.objExists(lt_clav_01_loc):
		...
		jointConvertRename(ori[1], system_name[3])
		lt_clav_01_bind = joint_chain[0]
		# print('Clav Bind:', lt_clav_01_bind)
	else:
	...
	if pm.objExists(lt_eye_01_loc):
		...
		jointConvertRename(ori[1], system_name[6])
		lt_eye_01_bind = joint_chain[0]
		# print('Eye Bind:', lt_eye_01_bind)
	else:
	...
	if pm.objExists(lt_hand_01_loc):
		...
		jointConvertRename(ori[1], system_name[9])
		lt_hand_01_bind = joint_chain[0]
		# print(' Hand Bind:', lt_hand_01_bind)
	else:
	...
	if pm.objExists(lt_index_01_loc):
		...
		jointConvertRename(ori[1], system_name[10])
		lt_index_01_bind= joint_chain[0]
		# print('Index Bind:', lt_index_01_bind)
	else:
	...
	if pm.objExists(lt_leg_01_loc):
		...
		jointConvertRename(ori[1], system_name[15])
		lt_leg_01_bind = joint_chain[0]
		# print(' Leg Bind:', lt_leg_01_bind)
	else:
	...
	if pm.objExists(lt_middle_01_loc):
		...
		jointConvertRename(ori[1], system_name[11])
		lt_middle_01_bind = joint_chain[0]
		# print('Middle Bind:', lt_middle_01_bind)
	else:
	...
	if pm.objExists(lt_pinky_01_loc):
		...
		jointConvertRename(ori[1], system_name[13])
		lt_pinky_01_bind = joint_chain[0]
		# print('Pinky Bind:', lt_pinky_01_bind)
	else:
	...
	if pm.objExists(lt_ring_01_loc):
		...
		jointConvertRename(ori[1], system_name[12])
		lt_ring_01_bind = joint_chain[0]
		# print('Ring Bind:', lt_ring_01_bind)
	else:
	...
	if pm.objExists(lt_toeA_01_loc):
		...
		jointConvertRename(ori[1], system_name[16])
		lt_toeA_01_bind = joint_chain[0]
		# print('Toe A Bind:', lt_toeA_01_bind)
	else:
	...
	if pm.objExists(lt_toeB_01_loc):
		...
		jointConvertRename(ori[1], system_name[17])
		lt_toeB_01_bind = joint_chain[0]
		print('Toe B Bind:', lt_toeB_01_bind)
	else:
	...
	if pm.objExists(lt_toeC_01_loc):
		...
		jointConvertRename(ori[1], system_name[18])
		lt_toeC_01_bind = joint_chain[0]
		print('Toe C Bind:', lt_toeC_01_bind)
	else:
	...
	if pm.objExists(lt_toeD_01_loc):
		...
		jointConvertRename(ori[1], system_name[19])
		lt_toeD_01_bind = joint_chain[0]
		print('Toe D Bind:', lt_toeD_01_bind)
	else:
	...
	if pm.objExists(lt_toeE_01_loc):
		...
		jointConvertRename(ori[1], system_name[20])
		lt_toeE_01_bind = joint_chain[0]
		print('Toe E Bind:', lt_toeE_01_bind)
	else:
	...
	if pm.objExists(lt_thumb_01_loc):
		...
		pm.select('joint1')
		thumb_joint_chain = pm.ls(sl=1, dag=1)
		lt_thumb_01_pivot = thumb_joint_chain[0]

		count = 0
		suffix = 'bind'

		for current_joint in thumb_joint_chain:
			count = count + 1
			new_name = '{0}_{1}_0{2}_{3}'.format(ori[1], system_name[14], count, suffix)
			current_joint.rename(new_name)

		new_name = '{0}_{1}_0{2}_{3}'.format(ori[1], system_name[14], count, 'waste')
		current_joint.rename(new_name)

		new_name = lt_thumb_01_pivot.replace('bind', 'pivot')
		lt_thumb_01_pivot.rename(new_name)

		pm.parent(lt_thumb_01_pivot, w=1)
	else:
	...
	pm.parent('ct_hip_01_bind', 'ct_root_01_waste')
	...
	'''
	Getting new joint selection and globals
	'''

	pm.select(ct_root_waste)
	main_jointChain = pm.ls(sl=1, dag=1)
	# print('Joints:', main_jointChain)
	ct_hip_bind = main_jointChain[1]
	rt_eye_01_bind = main_jointChain[39]
	rt_clav_01_bind = main_jointChain[73]
	rt_arm_01_bind = main_jointChain[75]
	rt_hand_01_bind = main_jointChain[78]
	rt_index_01_bind = main_jointChain[80]
	rt_middle_01_bind = main_jointChain[85]
	rt_ring_01_bind = main_jointChain[90]
	rt_pinky_01_bind = main_jointChain[95]
	rt_thumb_01_pivot = main_jointChain[100]
	rt_leg_01_bind = main_jointChain[105]
	rt_toeA_01_bind = main_jointChain[110]
	rt_toeB_01_bind = main_jointChain[113] 
	rt_toeC_01_bind = main_jointChain[116] 
	rt_toeD_01_bind = main_jointChain[119] 
	rt_toeE_01_bind = main_jointChain[122] 
	# print('Root Waste:', ct_root_waste)
	# print('Hip Bind:', ct_hip_bind)
	...
	pm.parent('*01*bind', '*01*pivot', w=1)

	pm.delete('*sLoc_grp', '*bone_grp', '*mult', '*_con', '*loc')
...
def dupIcons(*args):
	...
	rt_icons = pm.duplicate()
	pm.delete('biped_lt_eye_icon1')
	pm.delete('biped_lt_elbow_icon1|biped_lt_arm_hybrid_icon|biped_lt_arm_02_fk_icon_pointConstraint1')
	rt_icons = pm.ls(sl=1, dag=1, transforms=1)
	# print('Rt Icons:', rt_icons)
	rt_arm_01_fk_icon = rt_icons[0]
	rt_gimbal_icon = rt_icons[1]
	rt_arm_02_fk_icon = rt_icons[2]
	rt_arm_hybrid_icon = rt_icons[3]
	rt_arm_icon = rt_icons[4]
	rt_arm_ikfk_switch = rt_icons[5]
	rt_elbow_icon = rt_icons[6]
	rt_fingers_icon = rt_icons[7]
	rt_index_ik_icon = rt_icons[8]
	rt_middle_ik_icon = rt_icons[9]
	rt_ring_ik_icon = rt_icons[10]
	rt_pinky_ik_icon = rt_icons[11]
	rt_foot_icon = rt_icons[12]
	rt_hand_icon = rt_icons[13]
	rt_index_01_fk_icon = rt_icons[14]
	rt_index_02_fk_icon = rt_icons[15]
	rt_index_03_fk_icon = rt_icons[16]
	rt_index_04_fk_icon = rt_icons[17]
	rt_knee_icon = rt_icons[18]
	rt_leg_01_fk_icon = rt_icons[19]
	rt_leg_02_fk_icon = rt_icons[20]
	rt_leg_03_fk_icon = rt_icons[21]
	rt_leg_04_fk_icon = rt_icons[22]
	rt_leg_ikfk_switch = rt_icons[23]
	rt_middle_01_fk_icon = rt_icons[24]
	rt_middle_02_fk_icon = rt_icons[25]
	rt_middle_03_fk_icon = rt_icons[26]
	rt_middle_04_fk_icon = rt_icons[27]
	rt_pinky_01_fk_icon = rt_icons[28]
	rt_pinky_02_fk_icon = rt_icons[29]
	rt_pinky_03_fk_icon = rt_icons[30]
	rt_pinky_04_fk_icon = rt_icons[31]
	rt_ring_01_fk_icon = rt_icons[32]
	rt_ring_02_fk_icon = rt_icons[33]
	rt_ring_03_fk_icon = rt_icons[34]
	rt_ring_04_fk_icon = rt_icons[35]
	rt_shoulder_icon = rt_icons[36]
	rt_thumb_01_fk_pivot_icon = rt_icons[37]
	rt_thumb_02_fk_icon = rt_icons[38]
	rt_thumb_03_fk_icon = rt_icons[39]
	rt_thumb_04_fk_icon = rt_icons[40]

	rt_icon_grp = pm.group(empty=1)
	pm.parent(rt_icons, rt_icon_grp)
	rt_icon_grp.sx.set(-1)
	grp_name = rt_icon_grp.replace('null1', 'rt_icon_grp')
	rt_icon_grp.rename(grp_name)

	for each in rt_icons:
		rt_icon_name = each.replace('lt', 'rt')
		each.rename(rt_icon_name)

		rt_icon_name = each.replace('icon1', 'icon')
		each.rename(rt_icon_name)

	# print('rt_arm_01_fk_icon:', rt_arm_01_fk_icon)
	# print('rt_gimbal_icon:', rt_gimbal_icon)
	# print('rt_arm_02_fk_icon:', rt_arm_02_fk_icon)
	# print('rt_arm_hybrid_icon:', rt_arm_hybrid_icon)
	# print('rt_arm_icon:', rt_arm_icon)
	# print('rt_arm_ikfk_switch:', rt_arm_ikfk_switch)
	# print('rt_elbow_icon:', rt_elbow_icon)
	# print('rt_fingers_icon:', rt_fingers_icon)
	# print('rt_index_ik_icon:', rt_index_ik_icon)
	# print('rt_middle_ik_icon:', rt_middle_ik_icon)
	# print('rt_ring_ik_icon:', rt_ring_ik_icon)
	# print('rt_pinky_ik_icon:', rt_pinky_ik_icon)
	# print('rt_foot_icon:', rt_foot_icon)
	# print('rt_hand_icon:', rt_hand_icon)
	# print('rt_index_01_fk_icon:', rt_index_01_fk_icon)
	# print('rt_index_02_fk_icon:', rt_index_02_fk_icon)
	# print('rt_index_03_fk_icon:', rt_index_03_fk_icon)
	# print('rt_index_04_fk_icon:', rt_index_04_fk_icon)
	# print('rt_knee_icon:', rt_knee_icon)
	# print('rt_leg_01_fk_icon:', rt_leg_01_fk_icon)
	# print('rt_leg_02_fk_icon:', rt_leg_02_fk_icon)
	# print('rt_leg_03_fk_icon:', rt_leg_03_fk_icon)
	# print('rt_leg_04_fk_icon:', rt_leg_04_fk_icon)
	# print('rt_leg_ikfk_switch:', rt_leg_ikfk_switch)
	# print('rt_middle_01_fk_icon:', rt_middle_01_fk_icon)
	# print('rt_middle_02_fk_icon:', rt_middle_02_fk_icon)
	# print('rt_middle_03_fk_icon:', rt_middle_03_fk_icon)
	# print('rt_middle_04_fk_icon:', rt_middle_04_fk_icon)
	# print('rt_pinky_01_fk_icon:', rt_pinky_01_fk_icon)
	# print('rt_pinky_02_fk_icon:', rt_pinky_02_fk_icon)
	# print('rt_pinky_03_fk_icon:', rt_pinky_03_fk_icon)
	# print('rt_pinky_04_fk_icon:', rt_pinky_04_fk_icon)
	# print('rt_ring_01_fk_icon:', rt_ring_01_fk_icon)
	# print('rt_ring_02_fk_icon:', rt_ring_02_fk_icon)
	# print('rt_ring_03_fk_icon:', rt_ring_03_fk_icon)
	# print('rt_ring_04_fk_icon:', rt_ring_04_fk_icon)
	# print('rt_shoulder_icon:', rt_shoulder_icon)
	# print('rt_thumb_01_fk_pivot_icon:', rt_thumb_01_fk_pivot_icon)
	# print('rt_thumb_02_fk_icon:', rt_thumb_02_fk_icon)
	# print('rt_thumb_03_fk_icon:', rt_thumb_03_fk_icon)
	# print('rt_thumb_04_fk_icon:', rt_thumb_04_fk_icon)

	rt_icons = [rt_arm_01_fk_icon, rt_gimbal_icon, rt_arm_02_fk_icon, rt_arm_hybrid_icon, rt_arm_icon, 
				rt_arm_ikfk_switch, rt_elbow_icon, rt_fingers_icon, rt_index_ik_icon, rt_middle_ik_icon, 
				rt_ring_ik_icon, rt_pinky_ik_icon, rt_foot_icon, rt_hand_icon, rt_index_01_fk_icon, 
				rt_index_02_fk_icon, rt_index_03_fk_icon, rt_index_04_fk_icon, rt_knee_icon, rt_leg_01_fk_icon, 
				rt_leg_02_fk_icon, rt_leg_03_fk_icon, rt_leg_04_fk_icon, rt_leg_ikfk_switch, 
				rt_middle_01_fk_icon, rt_middle_02_fk_icon, rt_middle_03_fk_icon, rt_middle_04_fk_icon, 
				rt_pinky_01_fk_icon, rt_pinky_02_fk_icon, rt_pinky_03_fk_icon, rt_pinky_04_fk_icon, 
				rt_ring_01_fk_icon, rt_ring_02_fk_icon, rt_ring_03_fk_icon, rt_ring_04_fk_icon, 
				rt_shoulder_icon, rt_thumb_01_fk_pivot_icon, rt_thumb_02_fk_icon, rt_thumb_03_fk_icon, 
				rt_thumb_04_fk_icon]
...
def worldIcon(*args):
	global world_icon, anim_icon

	pm.select(scaledIcons[10])

	world_icon = pm.ls(sl=1)[0]
	# print('Move All:', world_icon)

	icon_name = world_icon.replace('biped_', '')
	world_icon.rename(icon_name)

	pm.select(scaledIcons[0])

	anim_icon = pm.ls(sl=1)[0]
	# print('Anim Icon:', anim_icon)

	icon_name = anim_icon.replace('biped_', '')
...
def headSetup(*args):
	...
	'''
	Get the head icon translates
	'''
	head_icon_tx = pm.getAttr(scaledIcons[7] + '.tx')
	head_icon_ty = pm.getAttr(scaledIcons[7] + '.ty')
	head_icon_tz = pm.getAttr(scaledIcons[7] + '.tz')
	# print('Head Translation X:', head_icon_tx)
	# print('Head Translation Y:', head_icon_ty)
	# print('Head Translation Z:', head_icon_tz)

	'''
	Get the head icon scales
	'''
	head_icon_sx = pm.getAttr(scaledIcons[7] + '.sx')
	head_icon_sy = pm.getAttr(scaledIcons[7] + '.sy')
	head_icon_sz = pm.getAttr(scaledIcons[7] + '.sz')
	# prins('Head Scale X:', head_icon_sx)
	# prins('Head Scale Y:', head_icon_sy)
	# prins('Head Scale Z:', head_icon_sz)

	pm.xform(head_icon, translation=[head_icon_tx, head_icon_ty, head_icon_tz], s=[head_icon_sx, head_icon_sy, head_icon_sz])
	freezeTransform(head_icon)
	deleteHistory()
	...
	yellowIndex(head_icon)

	pm.select(head_icon)
	freezeTransform()

	pm.delete(scaledIcons[7])
...
def eyeSetup(*args):
	...
	'''
	Get Ct Eye icon scale
	'''

	ct_eye_icon_sx = pm.getAttr(scaledIcons[6] + '.sx')
	ct_eye_icon_sy = pm.getAttr(scaledIcons[6] + '.sy')
	ct_eye_icon_sz = pm.getAttr(scaledIcons[6] + '.sz')

	'''
	Get Ct Eye icon translate
	'''

	ct_eye_icon_tx = pm.getAttr(scaledIcons[6] + '.tx')
	ct_eye_icon_ty = pm.getAttr(scaledIcons[6] + '.ty')
	ct_eye_icon_tz = pm.getAttr(scaledIcons[6] + '.tz')
	...
	pm.select(ct_eye_icon + '.cv[7]', 
			  ct_eye_icon + '.cv[3]')
	cmds.scale(1.30, 1, 1, p=(0, 0, 0), r=1)
	...
	pm.xform(ct_eye_icon, t=[ct_eye_icon_tx, ct_eye_icon_ty, ct_eye_icon_tz], s=[ct_eye_icon_sx, ct_eye_icon_sy, ct_eye_icon_sz])
	freezeTransform(ct_eye_icon)

	'''
	Get lt & rt eye icon scale
	'''

	lt_eye_icon_sx = pm.getAttr(scaledIcons[19] + '.sx')
	lt_eye_icon_sy = pm.getAttr(scaledIcons[19] + '.sy')
	lt_eye_icon_sz = pm.getAttr(scaledIcons[19] + '.sz')

	rt_eye_icon_sx = pm.getAttr(scaledIcons[55] + '.sx')
	rt_eye_icon_sy = pm.getAttr(scaledIcons[55] + '.sy')
	rt_eye_icon_sz = pm.getAttr(scaledIcons[55] + '.sz')

	pm.xform(lt_eye_icon, s=[lt_eye_icon_sx, lt_eye_icon_sy, lt_eye_icon_sz])

	pm.xform(rt_eye_icon, s=[rt_eye_icon_sx, rt_eye_icon_sy, rt_eye_icon_sz])

	temp_constraint = pm.pointConstraint(lt_eye_root, lt_eye_icon, skip=['y', 'z'], mo=0)
	pm.delete(temp_constraint)
	freezeTransform(lt_eye_icon)

	temp_constraint = pm.pointConstraint(rt_eye_root, rt_eye_icon, skip=['y', 'z'], mo=0)
	pm.delete(temp_constraint)
	freezeTransform(rt_eye_icon)
	...
	pm.delete(scaledIcons[6])

	pm.parent(lt_eye_root, rt_eye_root, head_root)
...
def jawSetup(*args):
	...
	jaw_joint_02 = selection[1]

	pm.joint(jaw_root, zso=1, ch=1, e=1, oj='xyz', secondaryAxisOrient='yup')
	jaw_joint_02.jointOrientX.set(0)

	pm.select(scaledIcons[9])
	jaw_icon = pm.ls(sl=1)[0]
	print('Jaw Icon:', jaw_icon)
	pm.delete(jaw_icon, constraints=1)
	freezeTransform(jaw_icon)
	...
	icon_name = jaw_icon.replace('biped_', '')
...
def neckSetup(*args):
	...
	'''
	Create the ik and fk icons
	'''

	pm.select(scaledIcons[12])
	neck_ik_icon = pm.ls(sl=1)[0]
	print('Neck IK Icon:', neck_ik_icon)
	unlock_and_unhide(neck_ik_icon, ['ty', 'tx', 'tz', 'rx', 'ry', 'rz'])
	pm.delete(neck_ik_icon, constraints=1)


	freezeTransform(neck_ik_icon)
	deleteHistory(neck_ik_icon)

	icon_name = neck_ik_icon.replace('biped_', '')
	neck_ik_icon.rename(icon_name)

	pm.parentConstraint(neck_ik_icon, cb_joint_2, mo=1)


	pm.select(scaledIcons[11])
	neck_fk_icon = pm.ls(sl=1)[0]
	print('Neck FK Icon:', neck_fk_icon)
	unlock_and_unhide(neck_fk_icon, ['ty', 'tx', 'tz', 'rx', 'ry', 'rz'])
	pm.delete(neck_fk_icon, constraints=1)
	freezeTransform(neck_fk_icon)
	deleteHistory(neck_fk_icon)

	icon_name = neck_fk_icon.replace('biped_', '')
	neck_fk_icon.rename(icon_name)
	...
	lock_and_hide(neck_ik_icon, ['sx', 'sy', 'sz'])
	lock_and_hide(neck_fk_icon, ['ty', 'tx', 'tz', 'sx', 'sy', 'sz'])
	...
	pm.parentConstraint(world_icon, neck_pad, mo=1)
	...
	# pm.connectAttr(ct_neck_stretchBlend + '.outputG', neck_ik_joint_2 + '.sx')
	# pm.connectAttr(ct_neck_stretchBlend + '.outputB', neck_ik_joint_3 + '.sx')
...
def backSetup(*args):
	...
	'''
	pm.select(scaledIcons[3])
	back_icon = pm.ls(sl=1)[0]
	pm.delete(back_icon, constraints=1)
	freezeTransform(back_icon)
	deleteHistory(back_icon)
	icon_naame = back_icon.replace('biped_', '')
	back_icon.rename(icon_naame)

	pm.select(scaledIcons[4])
	chest_icon = pm.ls(sl=1)[0]
	freezeTransform()
	deleteHistory(chest_icon)
	icon_naame = chest_icon.replace('biped_', '')
	...
	pm.select(scaledIcons[1])
	back_fk_icon_1 = pm.ls(sl=1)[0]
	freezeTransform()
	deleteHistory(back_fk_icon_1)

	pm.select(scaledIcons[2])
	back_fk_icon_2 = pm.ls(sl=1)[0]
	...
	icon_naame = back_fk_icon_1.replace('biped_', '')
	back_fk_icon_1.rename(icon_naame)

	icon_naame = back_fk_icon_2.replace('biped_', '')
	...
	lock_and_hide(back_fk_icon_1, ['tx', 'ty', 'tz', 'sx', 'sy', 'sz', 'v'])
	lock_and_hide(back_fk_icon_2, ['tx', 'ty', 'tz', 'sx', 'sy', 'sz', 'v'])
	lock_and_hide(back_global, ['sx', 'sy', 'sz'])
...
def hipSetup(*args):
	...
	pm.select(scaledIcons[8])
	hip_icon = pm.ls(sl=1)[0]
	freezeTransform()
	deleteHistory()

	icon_name = hip_icon.replace('biped_', '')
	...
	Create the COG icon
	'''
	pm.select(scaledIcons[5])
	cog_icon = pm.ls(sl=1)[0]
	freezeTransform()
	deleteHistory()

	icon_name = cog_icon.replace('biped_', '')
...
def lt_shoulderSetup(*args):
	...
	# Create the dist locs and rename them
	...
	# Create and rename the dist node
	...
	# Connect the locs to the dist node
	...
	pm.select(scaledIcons[50])
	lt_shoulder_icon = pm.ls(sl=1)[0]
	print('Lt Shoulder Icon:', lt_shoulder_icon)
	pm.delete(lt_shoulder_icon, constraints=1)
	freezeTransform(lt_shoulder_icon)

	icon_name = lt_shoulder_icon.replace('biped_', '')
	...
	lt_shoulder_icon.stretch.set(1)
...
def rt_shoulderSetup(*args):
	...
	pm.select(rt_icons[36])
	rt_shoulder_icon = pm.ls(sl=1)[0]
	pm.delete(rt_shoulder_icon, constraints=1)
	freezeTransform(rt_shoulder_icon)

	icon_name = rt_shoulder_icon.replace('biped_', '')
	...
	rt_shoulder_icon.stretch.set(1)
...
def lt_armSetup(*args):
	global lt_arm_root, lt_arm_fk_root, lt_arm_ik_root, lt_joint_12, lt_arm_icon
	...
	lt_arm_fk_joints = pm.duplicate(lt_arm_root)
	pm.select(lt_arm_fk_joints)
	lt_arm_fk_joints = pm.ls(sl=True, dag=True)
	lt_arm_fk_root = lt_arm_fk_joints[0]
	lt_arm_fk_joint_2 = lt_arm_fk_joints[1]
	lt_arm_fk_joint_3 = lt_arm_fk_joints[2]
	# print 'Fk Root:', lt_arm_fk_root
	# print 'Fk Joint 2:', lt_arm_fk_joint_2
	# print 'Fk Joint 3:', lt_arm_fk_joint_3

	
	joint_name = lt_arm_ik_root.replace('ik', 'fk')
	lt_arm_fk_root.rename(joint_name)

	joint_name = lt_arm_ik_joint_2.replace('ik', 'fk')
	lt_arm_fk_joint_2.rename(joint_name)

	joint_name = lt_arm_ik_joint_3.replace('ik', 'fk')
	lt_arm_fk_joint_3.rename(joint_name)

	lt_hybrid_fk_joints = pm.duplicate(lt_arm_fk_joint_2)
	...
	jnt_name = lt_arm_fk_joint_2.replace('fk', 'hybridFk')
	...
	pm.connectAttr(lt_arm_fk_root + '.rotate', lt_root_rot_ikfk + '.color1')
	...
	pm.connectAttr(lt_arm_fk_joint_2 + '.rotate', lt_arm_joint_2_rot_ikfk + '.color1')
	...
	pm.connectAttr(lt_arm_fk_joint_3 + '.rotate', lt_arm_joint_3_rot_ikfk + '.color1')
	...
	pm.connectAttr(lt_arm_fk_root + '.translate', lt_root_trans_ikfk + '.color1')
	...
	pm.connectAttr(lt_arm_fk_joint_2 + '.translate', lt_arm_joint_2_trans_ikfk + '.color1')
	...
	pm.connectAttr(lt_arm_fk_joint_3 + '.translate', lt_arm_joint_3_trans_ikfk + '.color1')
	pm.connectAttr(lt_arm_joint_3_trans_ikfk + '.output', lt_arm_joint_3 + '.translate')

	pm.select(scaledIcons[16])
	lt_arm_icon = pm.ls(sl=1)[0]
	freezeTransform()
	deleteHistory()
	...
	'''
	pm.select(scaledIcons[17])
	lt_arm_switch = pm.ls(sl=1)[0]
	unlock_and_unhide(lt_arm_switch, ['tx', 'ty', 'tz', 'rx', 'ry', 'rz', 'sx', 'sy', 'sz', 'v'])
	pm.delete(lt_arm_switch, constraints=1)
	freezeTransform()
	deleteHistory()
	lt_arm_switch_name = lt_arm_switch.replace('biped_', '')
	lt_arm_switch.rename(lt_arm_switch_name)
	pm.parentConstraint(lt_arm_joint_3, lt_arm_switch, mo=1)

	'''
	Add IkFk attribute
	'''
	pm.addAttr(lt_arm_switch, ln="IkFk", nn='Ik/Fk', max=1, dv=0, at='double', min=0)
	lt_arm_switch.IkFk.set(e=1, keyable=True)

	'''
	Lock and hide attrs
	'''
	attrs = ['tx', 'ty', 'tz', 'rx', 'ry', 'rz', 'sx', 'sy', 'sz', 'v']
	lock_and_hide(lt_arm_switch, attrs)
	'''
	Connect the blend attrs the the lt_arm_switch
	'''
	pm.connectAttr(lt_arm_switch + '.IkFk', lt_root_rot_ikfk + '.blender')
	pm.connectAttr(lt_arm_switch + '.IkFk', lt_arm_joint_2_rot_ikfk + '.blender')
	pm.connectAttr(lt_arm_switch + '.IkFk', lt_arm_joint_3_rot_ikfk + '.blender')
	pm.connectAttr(lt_arm_switch + '.IkFk', lt_root_trans_ikfk + '.blender')
	pm.connectAttr(lt_arm_switch + '.IkFk', lt_arm_joint_2_trans_ikfk + '.blender')
	pm.connectAttr(lt_arm_switch + '.IkFk', lt_arm_joint_3_trans_ikfk + '.blender')
	...
	pm.delete(temp_constraint)
	pm.parent(lt_arm_fk_icon_2, lt_arm_fk_pad_2)
	pm.select(lt_arm_fk_icon_2)
	freezeTransform()
	pm.parent(lt_arm_fk_pad_2, lt_arm_fk_icon_1)

	'''
	Rename the icons and the lt_arm_pads
	'''
	icon_name = lt_arm_fk_icon_1.replace('biped_', '')
	lt_arm_fk_icon_1.rename(icon_name)

	icon_name = lt_arm_fk_icon_2.replace('biped_', '')
	lt_arm_fk_icon_2.rename(icon_name)

	pad_name = lt_arm_fk_icon_1.replace('icon', 'local')
	lt_arm_fk_pad_1.rename(pad_name)

	pad_name = lt_arm_fk_icon_2.replace('icon', 'local')
	lt_arm_fk_pad_2.rename(pad_name) 
	...
	Create length attr
	'''
	pm.addAttr(lt_arm_fk_icon_1, ln='length', at='double', min=0, dv=1)
	lt_arm_fk_icon_1.length.set(e=1, keyable=True)
	pm.setDrivenKeyframe(lt_arm_fk_pad_2 + '.tx', currentDriver=lt_arm_fk_icon_1 + '.length')
	lt_arm_fk_icon_1.length.set(0)
	lt_arm_fk_pad_2.tx.set(0)
	pm.setDrivenKeyframe(lt_arm_fk_pad_2 + '.tx', currentDriver=lt_arm_fk_icon_1 + '.length')
	lt_arm_fk_icon_1.length.set(1)
	pm.keyTangent(lt_arm_fk_pad_2, 'graphEditor1FromOutliner', itt='spline', animation='objects', ott='spline')
	pm.mel.selectKey(lt_arm_fk_pad_2 + '.tx', add=1, k=1, f=1)
	pm.setInfinity(poi='linear')

	pm.addAttr(lt_arm_fk_icon_2, ln='length', at='double', min=0, dv=1)
	lt_arm_fk_icon_2.length.set(e=1, keyable=True)
	pm.setDrivenKeyframe(lt_arm_fk_joint_3 + '.tx', currentDriver=lt_arm_fk_icon_2 + '.length')
	lt_arm_fk_icon_2.length.set(0)
	lt_arm_fk_joint_3.tx.set(0)
	pm.setDrivenKeyframe(lt_arm_fk_joint_3 + '.tx', currentDriver=lt_arm_fk_icon_2 + '.length')
	lt_arm_fk_icon_2.length.set(1)
	pm.keyTangent(lt_arm_fk_joint_3, 'graphEditor1FromOutliner', itt='spline', animation='objects', ott='spline')
	pm.mel.selectKey(lt_arm_fk_joint_3 + '.tx', add=1, k=1, f=1)
	pm.setInfinity(poi='linear')
	...
	pm.select(scaledIcons[18])
	lt_elbow_icon = pm.ls(sl=1)[0]
	freezeTransform()
	deleteHistory()
	...
	Rename elbow icon
	'''
	icon_name = lt_elbow_icon.replace('biped_', '')
	lt_elbow_icon.rename(icon_name)
	...
	'''
	lt_arm_fk_pad_1.v.set(0)
	pm.setDrivenKeyframe(lt_arm_fk_pad_1 + '.v', currentDriver= lt_arm_switch + '.IkFk')
	pm.setDrivenKeyframe(lt_arm_icon + '.v', currentDriver= lt_arm_switch + '.IkFk')
	pm.setDrivenKeyframe(lt_elbow_icon + '.v', currentDriver= lt_arm_switch + '.IkFk')
	lt_arm_switch.IkFk.set(1)
	lt_arm_fk_pad_1.v.set(1)
	lt_arm_icon.v.set(0)
	lt_elbow_icon.v.set(0)
	pm.setDrivenKeyframe(lt_arm_fk_pad_1 + '.v', currentDriver= lt_arm_switch + '.IkFk')
	pm.setDrivenKeyframe(lt_arm_icon + '.v', currentDriver= lt_arm_switch + '.IkFk')
	pm.setDrivenKeyframe(lt_elbow_icon + '.v', currentDriver= lt_arm_switch + '.IkFk')
	lt_arm_switch.IkFk.set(0.1)
	lt_arm_fk_pad_1.v.set(1)
	lt_arm_icon.v.set(1)
	...
	pm.select(scaledIcons[15])
	lt_hIcon = pm.ls(sl=1)[0]

	lt_hPad = pm.group(empty=1)
	temp_constraint = pm.parentConstraint(lt_hJ_1, lt_hPad, mo=0)
	pm.delete(temp_constraint)
	# print lt_hPad
	# print lt_hIcon
	pm.parent(lt_hIcon, lt_hPad)
	freezeTransform()
	deleteHistory()

	pm.addAttr(lt_hIcon, ln='length', at='double', dv=0)
	unlock_and_unhide(lt_hIcon, ['length'])
	...
	pm.orientConstraint(lt_hIcon, lt_hJ_1, mo=1)
	...
	lt_arm_dnt_grp = pm.group(lt_loc_1,lt_loc_2, lt_loc_3, lt_arm_dist, lt_twist_grp, lt_arm_root, lt_arm_ik_root, lt_arm_fk_root, lt_snapDist_1, lt_snapDist_2, lt_ik_cons_grp, lt_hJ_pad)
	...
	pm.parent(lt_arm_icon, lt_elbow_icon, lt_arm_pad, lt_arm_switch, lt_arm_fk_pad_1, lt_arm_dnt_grp, lt_arm_global)
	...
	pm.orientConstraint(lt_core_icon, lt_arm_fk_pad_1, mo=1)
	...
	pm.connectAttr(lt_arm_switch + '.IkFk', lt_gimbal_core_tog + '.blender')
	pm.connectAttr(lt_arm_switch + '.IkFk', lt_core_icon + '.v')


	pm.select(lt_loc_1, lt_loc_2, lt_loc_3, lt_loc_4, lt_loc_5, lt_snapDist_1, lt_snapDist_2, lt_arm_ik_root, lt_arm_dist, lt_arm_ikh, lt_arm_ik_1, lt_arm_ik_2, lt_arm_root, lt_arm_curve_1, lt_arm_curve_2, lt_hJ_1, lt_arm_fk_root)
	selection = pm.ls(sl=1)
	for each in selection:
		pm.setAttr(each + '.visibility', 0)
	...
	pm.pointConstraint(lt_clav_space_loc, lt_arm_fk_pad_1, mo=1)
	...
	lock_and_hide(lt_arm_fk_icon_1, attrs)
	lock_and_hide(lt_arm_fk_icon_2, attrs)
...
def rt_armSetup(*args):
	global rt_arm_root, rt_arm_fk_root, rt_arm_ik_root, rt_joint_12, rt_arm_icon
	...
	rt_arm_fk_joints = pm.duplicate(rt_arm_root)
	pm.select(rt_arm_fk_joints)
	rt_arm_fk_joints = pm.ls(sl=True, dag=True)
	rt_arm_fk_root = rt_arm_fk_joints[0]
	rt_arm_fk_joint_2 = rt_arm_fk_joints[1]
	rt_arm_fk_joint_3 = rt_arm_fk_joints[2]
	# print 'Fk Root:', rt_arm_fk_root
	# print 'Fk Joint 2:', rt_arm_fk_joint_2
	# print 'Fk Joint 3:', rt_arm_fk_joint_3

	
	joint_name = rt_arm_ik_root.replace('ik', 'fk')
	rt_arm_fk_root.rename(joint_name)

	joint_name = rt_arm_ik_joint_2.replace('ik', 'fk')
	rt_arm_fk_joint_2.rename(joint_name)

	joint_name = rt_arm_ik_joint_3.replace('ik', 'fk')
	rt_arm_fk_joint_3.rename(joint_name)

	rt_hybrid_fk_joints = pm.duplicate(rt_arm_fk_joint_2)
	...
	jnt_name = rt_arm_fk_joint_2.replace('fk', 'hybridFk')
	...
	pm.connectAttr(rt_arm_fk_root + '.rotate', rt_root_rot_ikfk + '.color1')
	...
	pm.connectAttr(rt_arm_fk_joint_2 + '.rotate', rt_arm_joint_2_rot_ikfk + '.color1')
	...
	pm.connectAttr(rt_arm_fk_joint_3 + '.rotate', rt_arm_joint_3_rot_ikfk + '.color1')
	...
	pm.connectAttr(rt_arm_fk_root + '.translate', rt_root_trans_ikfk + '.color1')
	...
	pm.connectAttr(rt_arm_fk_joint_2 + '.translate', rt_arm_joint_2_trans_ikfk + '.color1')
	...
	pm.connectAttr(rt_arm_fk_joint_3 + '.translate', rt_arm_joint_3_trans_ikfk + '.color1')
	pm.connectAttr(rt_arm_joint_3_trans_ikfk + '.output', rt_arm_joint_3 + '.translate')

	pm.select(rt_icons[4])
	...
	'''
	pm.select(rt_icons[5])
	rt_arm_switch = pm.ls(sl=1)[0]
	unlock_and_unhide(rt_arm_switch, ['tx', 'ty', 'tz', 'rx', 'ry', 'rz', 'sx', 'sy', 'sz', 'v'])
	...
	Add IkFk attribute
	'''
	pm.addAttr(rt_arm_switch, ln="IkFk", nn='Ik/Fk', max=1, dv=0, at='double', min=0)
	rt_arm_switch.IkFk.set(e=1, keyable=True)

	'''
	Lock and hide attrs
	'''
	attrs = ['tx', 'ty', 'tz', 'rx', 'ry', 'rz', 'sx', 'sy', 'sz', 'v']
	lock_and_hide(rt_arm_switch, attrs)
	'''
	Connect the blend attrs the the rt_arm_switch
	'''
	pm.connectAttr(rt_arm_switch + '.IkFk', rt_root_rot_ikfk + '.blender')
	pm.connectAttr(rt_arm_switch + '.IkFk', rt_arm_joint_2_rot_ikfk + '.blender')
	pm.connectAttr(rt_arm_switch + '.IkFk', rt_arm_joint_3_rot_ikfk + '.blender')
	pm.connectAttr(rt_arm_switch + '.IkFk', rt_root_trans_ikfk + '.blender')
	pm.connectAttr(rt_arm_switch + '.IkFk', rt_arm_joint_2_trans_ikfk + '.blender')
	pm.connectAttr(rt_arm_switch + '.IkFk', rt_arm_joint_3_trans_ikfk + '.blender')
	...
	'''
	icon_name = rt_arm_fk_icon_1.replace('biped_', '')
	rt_arm_fk_icon_1.rename(icon_name)

	icon_name = rt_arm_fk_icon_2.replace('biped_', '')
	rt_arm_fk_icon_2.rename(icon_name)

	pad_name = rt_arm_fk_icon_1.replace('icon', 'local')
	rt_arm_fk_pad_1.rename(pad_name)

	pad_name = rt_arm_fk_icon_2.replace('icon', 'local')
	rt_arm_fk_pad_2.rename(pad_name) 



	pm.parentConstraint(rt_arm_fk_icon_1, rt_arm_fk_root, mo=1)
	pm.parentConstraint(rt_arm_fk_icon_2, rt_arm_fk_joint_2, mo=1)

	'''
	Create length attr
	'''
	pm.addAttr(rt_arm_fk_icon_1, ln='length', at='double', min=0, dv=1)
	rt_arm_fk_icon_1.length.set(e=1, keyable=True)
	pm.setDrivenKeyframe(rt_arm_fk_pad_2 + '.tx', currentDriver=rt_arm_fk_icon_1 + '.length')
	rt_arm_fk_icon_1.length.set(0)
	rt_arm_fk_pad_2.tx.set(0)
	pm.setDrivenKeyframe(rt_arm_fk_pad_2 + '.tx', currentDriver=rt_arm_fk_icon_1 + '.length')
	rt_arm_fk_icon_1.length.set(1)
	pm.keyTangent(rt_arm_fk_pad_2, 'graphEditor1FromOutliner', itt='spline', animation='objects', ott='spline')
	pm.mel.selectKey(rt_arm_fk_pad_2 + '.tx', add=1, k=1, f=1)
	pm.setInfinity(poi='linear')

	pm.addAttr(rt_arm_fk_icon_2, ln='length', at='double', min=0, dv=1)
	rt_arm_fk_icon_2.length.set(e=1, keyable=True)
	pm.setDrivenKeyframe(rt_arm_fk_joint_3 + '.tx', currentDriver=rt_arm_fk_icon_2 + '.length')
	rt_arm_fk_icon_2.length.set(0)
	rt_arm_fk_joint_3.tx.set(0)
	pm.setDrivenKeyframe(rt_arm_fk_joint_3 + '.tx', currentDriver=rt_arm_fk_icon_2 + '.length')
	rt_arm_fk_icon_2.length.set(1)
	pm.keyTangent(rt_arm_fk_joint_3, 'graphEditor1FromOutliner', itt='spline', animation='objects', ott='spline')
	pm.mel.selectKey(rt_arm_fk_joint_3 + '.tx', add=1, k=1, f=1)
	pm.setInfinity(poi='linear')
	...
	Rename elbow icon
	'''
	icon_name = rt_elbow_icon.replace('biped_', '')
	rt_elbow_icon.rename(icon_name)
	...
	Icon visibility SDKs
	'''
	rt_arm_fk_pad_1.v.set(0)
	pm.setDrivenKeyframe(rt_arm_fk_pad_1 + '.v', currentDriver= rt_arm_switch + '.IkFk')
	pm.setDrivenKeyframe(rt_arm_icon + '.v', currentDriver= rt_arm_switch + '.IkFk')
	pm.setDrivenKeyframe(rt_elbow_icon + '.v', currentDriver= rt_arm_switch + '.IkFk')
	rt_arm_switch.IkFk.set(1)
	rt_arm_fk_pad_1.v.set(1)
	rt_arm_icon.v.set(0)
	rt_elbow_icon.v.set(0)
	pm.setDrivenKeyframe(rt_arm_fk_pad_1 + '.v', currentDriver= rt_arm_switch + '.IkFk')
	pm.setDrivenKeyframe(rt_arm_icon + '.v', currentDriver= rt_arm_switch + '.IkFk')
	pm.setDrivenKeyframe(rt_elbow_icon + '.v', currentDriver= rt_arm_switch + '.IkFk')
	rt_arm_switch.IkFk.set(0.1)
	rt_arm_fk_pad_1.v.set(1)
	rt_arm_icon.v.set(1)
	...
	rt_hIcon = pm.ls(sl=1)[0]

	rt_hPad = pm.group(empty=1)
	temp_constraint = pm.parentConstraint(rt_hJ_1, rt_hPad, mo=0)
	pm.delete(temp_constraint)
	# print rt_hPad
	# print rt_hIcon
	pm.parent(rt_hIcon, rt_hPad)
	freezeTransform()
	deleteHistory()
	...
	pm.orientConstraint(rt_hIcon, rt_hJ_1, mo=1)
	...
	rt_arm_dnt_grp = pm.group(rt_loc_1,rt_loc_2, rt_loc_3, rt_arm_dist, rt_twist_grp, rt_arm_root, rt_arm_ik_root, rt_arm_fk_root, rt_snapDist_1, rt_snapDist_2, rt_ik_cons_grp, rt_hJ_pad)
	...
	pm.parent(rt_arm_icon, rt_elbow_icon, rt_arm_pad, rt_arm_switch, rt_arm_fk_pad_1, rt_arm_dnt_grp, rt_arm_global)
	...
	pm.orientConstraint(rt_core_icon, rt_arm_fk_pad_1, mo=1)
	...
	pm.connectAttr(rt_arm_switch + '.IkFk', rt_gimbal_core_tog + '.blender')
	pm.connectAttr(rt_arm_switch + '.IkFk', rt_core_icon + '.v')


	pm.select(rt_loc_1, rt_loc_2, rt_loc_3, rt_loc_4, rt_loc_5, rt_snapDist_1, rt_snapDist_2, rt_arm_ik_root, rt_arm_dist, rt_arm_ikh, rt_arm_ik_1, rt_arm_ik_2, rt_arm_root, rt_arm_curve_1, rt_arm_curve_2, rt_hJ_1, rt_arm_fk_root)
	selection = pm.ls(sl=1)
	for each in selection:
		pm.setAttr(each + '.visibility', 0)
	...
	pm.pointConstraint(rt_clav_space_loc, rt_arm_fk_pad_1, mo=1)
	...
	attrs = ['tx', 'ty', 'tz', 'sx', 'sy', 'sz', 'v']
	lock_and_hide(rt_arm_fk_icon_1, attrs)
	lock_and_hide(rt_arm_fk_icon_2, attrs)
...
def lt_handSetup(*args):
	...
	if pm.objExists('lt_arm_12_bind'):
		...
		pm.select(scaledIcons[23])
		lt_hand_icon = pm.ls(sl=1)[0]
		print('Lt Hand Icon:', lt_hand_icon)
		unlockAttrs(lt_hand_icon, ['rx', 'ry', 'rz', 'sx', 'sy', 'sz'])
		freezeTransform()

		icon_name = lt_hand_root.replace('01_bind', 'icon')
		print 'Icon name:', icon_name
		lt_hand_icon.rename(icon_name)
		...
		local_name = lt_hand_icon.replace('icon', 'local')
		...
		lt_hand_icon.localWorld.set(10)
		world_const.set(1)
		local_const.set(0)
		pm.setDrivenKeyframe(world_const, local_const, currentDriver= lt_hand_icon + '.localWorld')
...
def rt_handSetup(*args):
	...
	if pm.objExists('rt_arm_12_bind'):
		...
		pm.select(rt_icons[13])
		rt_hand_icon = pm.ls(sl=1)[0]
		print('Lt Hand Icon:', rt_hand_icon)
		unlockAttrs(rt_hand_icon, ['rx', 'ry', 'rz', 'sx', 'sy', 'sz'])
		freezeTransform()

		icon_name = rt_hand_root.replace('01_bind', 'icon')
		print 'Icon name:', icon_name
		rt_hand_icon.rename(icon_name)
		...
		local_name = rt_hand_icon.replace('icon', 'local')
		print 'Local Name:', local_name
		...
		rt_hand_icon.localWorld.set(10)
		world_const.set(1)
		local_const.set(0)
		pm.setDrivenKeyframe(world_const, local_const, currentDriver= rt_hand_icon + '.localWorld')
		...
		rt_hand_icon.overrideColor.set(red)
	else:
		pm.select(rt_arm_01_bind)
		arm_joints = pm.ls(sl=1, dag=1)
