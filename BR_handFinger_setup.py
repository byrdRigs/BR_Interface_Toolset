...
def gui():
	...
	pm.window('ByrdRigs_Hand_Window', e=1, wh=(240, 110), rtf=1)
...
def indexSetup():
	...
	global index_fk_01_shape, index_fk_02_shape, index_fk_03_shape
	'''
	Index
	'''
	...
	'''
	pm.connectAttr(index_fk_root + '.rotate', index_root + '.rotate')
	pm.connectAttr(index_fk_joint_2 + '.rotate', index_joint_2 + '.rotate')
	pm.connectAttr(index_fk_joint_3 + '.rotate', index_joint_3 + '.rotate')
	pm.connectAttr(index_fk_joint_4 + '.rotate', index_joint_4 + '.rotate')
	pm.connectAttr(index_fk_joint_5 + '.rotate', index_joint_5 + '.rotate')
...
def middleSetup():
	...
	global middle_fk_01_shape, middle_fk_02_shape, middle_fk_03_shape
	'''
	Middle
	'''
	...
	Connect the fk joints to the bind
	'''
	pm.connectAttr(middle_fk_root + '.rotate', middle_root + '.rotate')
	pm.connectAttr(middle_fk_joint_2 + '.rotate', middle_joint_2 + '.rotate')
	pm.connectAttr(middle_fk_joint_3 + '.rotate', middle_joint_3 + '.rotate')
	pm.connectAttr(middle_fk_joint_4 + '.rotate', middle_joint_4 + '.rotate')
	pm.connectAttr(middle_fk_joint_5 + '.rotate', middle_joint_5 + '.rotate')
